...
<style type="text/css">
  ...
  <link rel="stylesheet" href="weather.css" type="text/css"></link>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="card customMenux customMenuParent2"  style="height:350px">
					<div class="card-body ">
					    <h4 class="card-title">工单申请</h4>
						<span class="flushMenu iconfont icon-shuaxin"></span>
					</div>
					<div class="customMenu2 comment-widgets overflowyAuto scrollable ps-container ps-theme-default row data-ps-id="bdc7b288-a9a2-7cdc-e8cf-e439e93ee41f">
					</div>
				</div>
				<div class="col-lg-12 col-md-12 col-sm-12 customMenuParent2" style="padding:0">
					<div class="card customMenux" style="height:360px">
						<div class="card-body overflowyAuto">
							<h4 class="card-title">我的菜单</h4>
							<span class="flushMenu iconfont icon-shuaxin"></span>
						</div>
						<div class="customMenu3 overflowyAuto comment-widgets scrollable ps-container ps-theme-default row data-ps-id="bdc7b288-a9a2-7cdc-e8cf-e439e93ee41f">
						</div>
					</div>
				</div>
			</div>
...
<script>		
$(function() {
	var duty = 'dragMenus,personInfo';
	var data = getAllData(duty);
	initPersonInfo(data);
	initMenu(data);
	initWorkDate(data);
	loadWeather();
	$(".overflowyAuto").hover(function(){
		$(this).css("overflow-y","auto");
	},function(){
		$(this).css("overflow","hidden");
	})
	//菜单刷新
	$(".flushMenu").hover(function(){
		$(this).css("color","red");
	},function(){
		$(this).css("color","#6a7a8c");
	})
	...
	function refreshMenuRedis(){
		var duty = 'dragMenus';
		var data = getAllDatax(duty);
	}
...
function initNewsData(data){
	...
	function getAllDatax(e){
		var datas = {};
		$.ajax({
			url: "/myehr/dragconfig/refreshDragAllDatas.action?duty="+e,
			type: 'post',
			cache: false,
			async: false,
			success: function (data) {
